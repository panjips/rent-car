            ...
            <div class="container" style="text-align: left;">
                <div class="row">
                    ...
                    <div class="col-md animate__animated animate__fadeInRight">
                        <div class="card card-testimonial border" style="width: auto; margin-bottom: 50px; background-color: #FFFFFF;">
                            <div class="card-body">
                                <p class="card-title card-testimonial-title p-2">
                                    Avanza Veloz
                                </p>
                                <p class="card-title card-testimonial-text p-2" style="color: #6C757D;">
                                    Toyota Avanza Veloz adalah salah satu kendaraan MPV paling populer di Indonesia, dan untuk alasan yang bagus. Ini adalah pilihan ideal untuk pelanggan rental kendaraan yang mencari mobil yang luas, nyaman, dan stylish untuk perjalanan keluarga atau rombongan. Ditambah lagi, mobil ini bisa disewa dengan harga yang sangat terjangkau. Pastinya akan membuat liburan anda menyenangkan.
                                </p>
                                <div class="row">
                                    <div class="col-sm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm d-flex justify-content-end">
                                        <a class="btn btn-primary mt-2 align-items-center d-flex" 
                                            href="#" 
                                            data-toggle="modal"
                                            data-target="#sewaSekarangModal" 
                        ...
                        <div class="card card-testimonial border mb-3 review-card " style="background-color: #FFFFFF;">
                            <div class="card-body">
                                ...
                                <div class="row mb-4 displayed-review">
                                    <div class="col-sm">
                                        <img class="card-img-review" src="{{ asset('img/foto_patrick.jpeg') }}" alt="Card image cap" style="float: left; margin-left: 10px;">
                                    </div>
                                    <div class="col-lg-11 mt-0">
                                        <div class="row">
                                            <div class="col-sm">
                                                <p class="card-title card-review-title p-0" style="margin-top: -5px;">
                                                    {{ $item['nama'] }}
                                                </p>
                                            </div>
                                            <div class="col-sm d-flex justify-content-end">
                                        ...
                                        <p class="card-title card-review-text p-0" style="margin-top: -3px; color: #90A3BF;">
                                            {{ $item['tanggal'] }}
                                        </p>
                                ...
                                <div class="text-center">
                                    @if (count($review) > 2)
                                        <button class="btn btn-link" id="showAllReviews" style="text-decoration: none; color: #ABB5BE;">
                                            Show All
...
<div class="modal fade" id="sewaSekarangModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <div class="row" style="margin-bottom: -15px;">
                    <p class="modal-title modal-header-title">Avanza Veloz</p>
                    <p class="modal-header-subtitle">MPV - Matic - Oktan 91 - Putih</p>
                </div>
                <button type="button" class="close custom-close-button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" style="font-size: 24px; color: #333; font-weight: bold; background-color: transparent;">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-body">
                <form id="rentalForm">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control modal-form-placeholder-disabled" id="inputName" placeholder="Alex Stanton" disabled>
                    </div>
                    <div class="form-group mb-3">
                        <label for="pickUpDate" class="modal-form-label">Pick-up Date</label>
                        <input type="date" class="form-control modal-form-placeholder" id="pickUpDate" placeholder="16 October 2023">
                    </div>
                    <div class="form-group mb-3">
                        <label for="dropOffDate" class="modal-form-label">Drop-off Date</label>
                        <input type="date" class="form-control modal-form-placeholder" id="dropOffDate" placeholder="16 October 2023">
                    </div>
                    <div class="form-group mb-3">
                        <label for="pickUpLocation" class="modal-form-label">Pick-up Location</label>
                        <input type="text" class="form-control modal-form-placeholder" id="pickUpLocation" placeholder="Pick-up Location">
                    </div>
                    <div class="form-group mb-3">
                        <label for="dropOffLocation" class="modal-form-label">Drop-off Location</label>
                        <input type="text" class="form-control modal-form-placeholder" id="dropOffLocation" placeholder="Drop-off Location">
                    </div>
                    <div class="form-group mb-3">
...
<script>
    ...
    function updateTotalPrice() {
        ...
        const totalPriceElement = document.getElementById('totalPrice'); // Changed variable name to clarify it's an element
        const dailyPrice = 350000; // Replace with your actual daily price
