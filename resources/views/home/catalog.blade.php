        ...
        <div class="row home-header">
            <div class="container" style="text-align: left;">
                ...
                <div class="col-md animate__animated animate__fadeInUp">
                    <a href="/detail" class="card-link">
                        <div class="card card-testimonial border card-hover" style="width: 380px; margin-bottom: 50px; background-color: #FFFFFF;">
                            <div class="container">
                                <img class="card-img-top" src="{{ asset('img/alphard.png') }}" alt="alphard">
                            </div>
                            <div class="card-body">
