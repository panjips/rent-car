...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Comic+Neue:wght@400;700&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
            ...
            @if (Auth::guard('web')->check())
                <a href="/user">
                    <img src="{{ Auth::guard('web')->user()->gambar == null ? asset('img/user2-160x160.jpg') : asset('storage/profile/' . Auth::guard('web')->user()->gambar) }}"
                        class="rounded-circle elevation-2" alt="User Image" height="50px" width="50px">
                </a>
            @else
