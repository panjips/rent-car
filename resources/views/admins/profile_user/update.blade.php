        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('user/profile/' . Auth::guard('web')->user()->id_user) }}" id="formUpdateuser"
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-6">
                                    <label for="modal_gambar" class="fw-bold fs-6 form-label">Gambar
                                        User</label>
                                    <input type="file"
                                        class="form form-control clear @error('gambar') is-invalid @enderror" name="gambar"
                                        id="modal_gambar" placeholder="" value="{{ old('gambar', $user->gambar) }}">
                                    @error('gambar')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
