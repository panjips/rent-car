...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ request()->is('admin/dashboard') || request()->is('admin/dashboard/*') ? url('admin/dashboard') : url('dashboard') }}"
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    @if (request()->is('admin/dashboard') || request()->is('admin/dashboard/*'))
                        <div class="info">
                            <a href="javascript:void(0)" class="d-block text-decoration-none">Alex Gilbert</a>
                        </div>
                    @endif
                    @if (request()->is('dashboard') || request()->is('dashboard/*'))
                        <div class="info">
                            <a href="{{ url('dashboard/profile') }}" class="d-block text-decoration-none">Nama user</a>
                        </div>
                    @endif
